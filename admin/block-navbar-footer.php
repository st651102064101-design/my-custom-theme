    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            <ul class="navbar-nav <?php echo esc_attr($_nav_align_class); ?> mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link<?php echo is_front_page() ? ' active' : ''; ?>" href="<?php echo esc_url(kv_internal_url('/')); ?>"><?php echo esc_html(get_option('nav_home_label','Home')); ?></a>
                </li>
                <?php endif; ?>
                ...
                <li class="nav-item">
                    ...
                    $nav_about_href = kv_internal_url($nav_about_url);
                    ?>
                ...
                <li class="nav-item">
                    <a class="nav-link<?php echo $is_product_page ? ' active' : ''; ?>"
                       href="<?php echo esc_url(kv_internal_url('/products/')); ?>"><?php echo esc_html(get_option('nav_products_label','Products')); ?></a>
                </li>
                <?php endif; ?>
                <?php endif; ?>
                ...
                $nav_contact_href = kv_internal_url($nav_contact_url);
                ?>
                <li class="nav-item">
